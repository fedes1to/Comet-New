...
namespace IL2CPP
{
    ...
    public:
        ...
        TReturn CallStaticMethod(void* m_pMethod, TArgs... tArgs) { return reinterpret_cast<TReturn(UNITY_CALLING_CONVENTION)(TArgs...)>(m_pMethod)(tArgs...); }

        template<typename TReturn, typename... TArgs>
        TReturn CallStaticMethod(const char* m_pMethodName, TArgs... tArgs) { return CallMethod<TReturn>(GetMethodPointer(m_pMethodName), tArgs...); }
